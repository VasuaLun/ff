    ...
    begin
        ...
        begin -- Body
            ...
            loop
                ...
                for QKBK in
                (
                 select substr(KBK.SFKR,1,2) PART, substr(KBK.SFKR,3,2) SUBPART, KBK.SPARTICLE, KBK.SKVR, KBK.SCODE, KBK.SEVENT_CODE, KBK.STYPEBS_NUMB, E.RN EXPMAT, K.CODE KOSGUCODE, E.KOSGU DOPKOSGU
                  ...
                  where TG.JURPERS  = pJURPERS
                    ...
                    and E.KOSGURN   = K.RN
                    and TG.FOTYPE2  = 4
                  group by substr(KBK.SFKR,1,2), substr(KBK.SFKR,3,2), KBK.SPARTICLE, KBK.SKVR, KBK.SCODE, KBK.SEVENT_CODE, KBK.STYPEBS_NUMB, E.RN, K.CODE, E.KOSGU
