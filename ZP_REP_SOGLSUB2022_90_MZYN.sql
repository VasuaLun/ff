    ...
    begin
       ...
       order by TGP.PERIOD_NUM
        ...
        begin -- Body
            ...
            APKG_XLSREP.ADD_COLUMN(nWIDTH => 120, nCOUNT => 2);
            APKG_XLSREP.ADD_COLUMN(nWIDTH => 200);
            APKG_XLSREP.ADD_COLUMN(nWIDTH => 150, nCOUNT => 4);
            ...
            for MET in (
                select S.METHOD, S.CPERSONS, L.NAME, S.AGE, S.RESEARCH
                from Z_SCREENING S, Z_LOV L
            ...
            loop
                ...
                APKG_XLSREP.ADD_ROW (nHEIGHT => 35);
                APKG_XLSREP.ADD_CELL(sSTYLE => 'border_center_str', sCELLDATA => nCOUNT_STR, sCELLTYPE   => 'String');
                APKG_XLSREP.ADD_CELL(sSTYLE => 'border_left_str', sCELLDATA => MET.METHOD, sCELLTYPE => 'String');
                APKG_XLSREP.ADD_CELL(sSTYLE => 'border_right_num', sCELLDATA => MET.CPERSONS, sCELLTYPE   => 'Number');
                APKG_XLSREP.ADD_CELL(sSTYLE => 'border_left_str', sCELLDATA => MET.NAME||', '||MET.AGE, sCELLTYPE => 'String');
                APKG_XLSREP.ADD_CELL(sSTYLE => 'border_left_str', sCELLDATA => MET.RESEARCH, sCELLTYPE => 'String');
            end loop;
